...
def home(request):
	...
	if request.method == "POST":
		...
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=CA02AFED-1B36-42DB-B958-ECD4BC85CF6C")
		...
		if api :
			if api[0]['Category']['Name'] == "Good":
				...
				category_description = "(301 to higher) Health warning of emergency conditions: everyone is more likely to be affected."
		...
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=CA02AFED-1B36-42DB-B958-ECD4BC85CF6C")
